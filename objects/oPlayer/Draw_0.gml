...
draw_sprite_ext(capeNshirt,image_index,x,y,1,1,0,c_orange,1); //Draw White Cape and Shirt, works beautifully.
draw_self(); //Draw Base
#region Draw Sword
if(state="atk" && localFrame > 0){
	draw_sprite_ext(sPlayerSword,image_index,x,y,1,1,0,c_yellow,1);
